...
Route::prefix('')->group(function () {
    ...
    Route::controller(TeacherApiController::class)->middleware('auth:jwt')->group(function () {
        ...
        Route::patch('/teachers/{people_id}', 'update');                          // PATCH update teacher
        Route::patch('/teachers/{people_id}/verify', 'verify');                   // PATCH verify teacher appointment
    });
    ...
    Route::controller(DeoOfficerController::class)->middleware('auth:jwt')->prefix('deo-officers')->group(function () {
        ...
        Route::get('/{people_id}', 'show');            // GET single
        Route::patch('/{people_id}', 'update');        // PATCH update
        Route::delete('/{people_id}', 'destroy');      // DELETE deactivate
    });
