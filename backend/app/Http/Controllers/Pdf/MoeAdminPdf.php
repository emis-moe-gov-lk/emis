...
class MoeAdminPdf extends Controller
{
    public function generatePdf(string $peopleId)
    {
        ...
        // Load PDF using the MOE admin template
        $pdf = Pdf::loadView('pdf.moe-admin-profile-pdf', [
            'people' => $people,
            'qrCode' => $qrCode,
        ]);
        ...
        $fileName = 'moe-admin-profile-' . ($people->nic ?: $people->people_id) . '.pdf';
