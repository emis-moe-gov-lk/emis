...
class OfficeAdminPdf extends Controller
{
    public function generatePdf($peopleId)
    {
        ...
        // Load PDF using the new office admin template
        $pdf = Pdf::loadView('pdf.office-admin-profile-pdf', [
            'people' => $people,
            'qrCode' => $qrCode,
        ]);
        ...
        $fileName = 'admin-profile-' . ($people->nic ?: $people->people_id) . '.pdf';
