...
class ProvincialDeoPdf extends Controller
{
    public function generatePdf(string $peopleId)
    {
        ...
        // Load PDF using the Provincial DEO template
        $pdf = Pdf::loadView('pdf.provincial-deo-profile-pdf', [
            'people' => $people,
            'qrCode' => $qrCode,
        ]);
        ...
        $fileName = 'provincial-deo-profile-' . ($people->nic ?: $people->people_id) . '.pdf';
