...
class ProvincialAdminPdf extends Controller
{
    public function generatePdf(string $peopleId)
    {
        ...
        // Load PDF using the Provincial admin template
        $pdf = Pdf::loadView('pdf.provincial-admin-profile-pdf', [
            'people' => $people,
            'qrCode' => $qrCode,
        ]);
        ...
        $fileName = 'provincial-admin-profile-' . ($people->nic ?: $people->people_id) . '.pdf';
