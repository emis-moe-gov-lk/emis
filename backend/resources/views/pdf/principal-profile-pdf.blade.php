...
@php
    ...
    $institution = $currentAppointment?->institution;
    $zeo = $institution?->zonalEducationOffice;
    $peo = $zeo?->provincialEducationOffice;
    $pmoe = $peo?->provincialMinistryOfEducationOffice;
    $moe = $pmoe?->ministryOfEducationOffice;
    $deo = $institution?->divisionalEducationOffice;
...
<div class="header">
    <table class="header-table" width="100%">
        <tr>
            <td width="70%">
                <div class="badge">Principal Profile Document</div>
                <h1 class="title">{{ $fullName ?: $people->full_name ?: 'Principal Profile' }}</h1>
...
<div class="section">
    ...
    <table class="section-table" width="100%">
        ...
        <tr>
            <td colspan="2"><span class="label">Institution</span><span class="value">{{ $institution?->name ?? '—' }}</span></td>
            <td><span class="label">Zonal Office</span><span class="value">{{ $zeo?->name ?? '—' }}</span></td>
            <td><span class="label">Divisional Office</span><span class="value">{{ $deo?->name ?? '—' }}</span></td>
        </tr>
        <tr>
            <td><span class="label">Ministry</span><span class="value">{{ $moe?->name ?? '—' }}</span></td>
            <td><span class="label">Provincial Office</span><span class="value">{{ $peo?->name ?? '—' }}</span></td>
            <td><span class="label">Recruitment Category</span><span class="value">{{ $people->principal?->recruitmentCategory?->category_name ?? '—' }}</span></td>
