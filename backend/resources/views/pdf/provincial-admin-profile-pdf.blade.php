...
<head>
    ...
    <title>Provincial Administrator Profile</title>
    <style>
        @page {
            margin: 18px 22px;
        }
...
<div class="header">
    <table class="header-table" width="100%">
        <tr>
            <td width="70%">
                <div class="badge">Provincial Education Admin Profile Document</div>
                <h1 class="title">{{ $fullName ?: $people->full_name ?: 'Administrator Profile' }}</h1>
