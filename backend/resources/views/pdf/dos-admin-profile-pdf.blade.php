...
<head>
    ...
    <title>Zonal Administrator Profile</title>
    <style>
        @page {
            margin: 18px 22px;
        }
...
<div class="header">
    <table class="header-table" width="100%">
        <tr>
            <td width="70%">
                <div class="badge">Zonal Administrator Profile Document</div>
                <h1 class="title">{{ $fullName ?: $people->full_name ?: 'Zonal Administrator Profile' }}</h1>
...
<div class="section">
    ...
    <table class="section-table" width="100%">
        <tr>
            ...
            <td width="34%"><span class="label">Source</span><span class="value">Zonal Administrator Registry</span></td>
        </tr>
    </table>
</div>
