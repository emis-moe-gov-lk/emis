    ...
    <table class="header-table" width="100%">
        <tr>
            <td width="70%">
                ...
                <h1 class="title">{{ $fullName ?: $people->full_name ?: 'Teacher Profile' }}</h1>
...
<div class="section">
    ...
    <table class="section-table" width="100%">
        ...
        <tr>
            <td colspan="2"><span class="label">Institution</span><span class="value">{{ $workplace?->institution?->name ?? '—' }}</span></td>
        ...
        <tr>
            ...
            <td><span class="label">Current Teaching Subject</span><span class="value">{{ data_get($people, 'teacher.currentTeachingSubject.name_si', data_get($people, 'teacher.currentTeachingSubject.name_en', '—')) }}</span></td>
            <td><span class="label">Current Appointment Type</span><span class="value">{{ data_get($people, 'currentAppointment.appointment_type', data_get($people, 'appointment.appointment_type', '—')) }}</span></td>
        </tr>
    </table>
</div>
    ...
    <table class="section-table" width="100%">
        <tr>
            <td>
                ...
                <span class="value">{{ $subjects->isNotEmpty() ? $subjects->implode(', ') : '—' }}</span>
            </td>
        </tr>
    </table>
</div>
...
<div class="section">
    ...
    <table class="section-table" width="100%">
        <tr>
            <td width="25%"><span class="label">Teacher Category</span><span class="value">{{ data_get($people, 'teacher.teacherCategory.name', data_get($people, 'teacher.teacher_category', '—')) }}</span></td>
            <td width="25%"><span class="label">Trained</span><span class="value">{{ data_get($people, 'teacher.teacherCategory.name') === 'Trained' ? 'Yes' : 'No' }}</span></td>
            <td width="25%"><span class="label">Teacher Type</span><span class="value">{{ data_get($people, 'teacher.teacherType.type_name', data_get($people, 'teacher.teacher_type', '—')) }}</span></td>
            <td width="25%"><span class="label">Medium</span><span class="value">{{ data_get($people, 'teacher.medium.name', data_get($people, 'teacher.appointment_medium', '—')) }}</span></td>
        </tr>
        <tr>
            <td colspan="2"><span class="label">Appointment Subject</span><span class="value">{{ data_get($people, 'teacher.appointmentSubject.name_si', data_get($people, 'teacher.appointmentSubject.name_en', '—')) }}</span></td>
            <td><span class="label">Main Teaching Subject</span><span class="value">{{ data_get($people, 'teacher.mainSubject.name_si', data_get($people, 'teacher.mainSubject.name_en', '—')) }}</span></td>
            <td><span class="label">Secondary Subject</span><span class="value">{{ data_get($people, 'teacher.secondarySubject.name_si', data_get($people, 'teacher.secondarySubject.name_en', '—')) }}</span></td>
        </tr>
    </table>
</div>
...
<div class="section">
    ...
    <table class="section-table" width="100%">
        <tr>
            ...
            <td width="60%"><span class="label">Children / Relations</span><span class="value">{{ $familyMembers->isNotEmpty() ? 'Included in attached family data' : '—' }}</span></td>
        </tr>
        @forelse($familyMembers as $family)
            <tr>
                ...
                <td><span class="label">Notes</span><span class="value">{{ data_get($family, 'relationship', data_get($family, 'relation', '—')) }}</span></td>
            </tr>
        @empty
            <tr>
...
<div class="section">
    ...
    <table class="section-table" width="100%">
        <tr>
            ...
            <td width="80%"><span class="label">Status</span><span class="value">{{ collect($people->appointmentHistory ?? [])->isNotEmpty() ? 'Available in profile data' : 'No appointment history records found.' }}</span></td>
        </tr>
    </table>
</div>
