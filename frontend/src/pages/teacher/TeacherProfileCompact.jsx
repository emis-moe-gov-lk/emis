...
const TeacherProfileCompact = () => {
    ...
    return (
        <div className="space-y-4">
            ...
            <NavLink
                to="/teacher"
                className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-2 text-sm font-semibold text-white hover:bg-blue-700"
            >
                <HiArrowLeft />
                Back to List
            </NavLink>
            ...
            <div className="sticky top-16 z-20 rounded-2xl border bg-white shadow-sm">
                <div className="flex flex-wrap items-center gap-4 p-4">
                    ...
                    <div className="flex-1 min-w-[220px]">
                        ...
                        <div className="text-sm text-gray-500">{teacher.service}</div>
                    </div>
                ...
                {/* ID STRIP */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 border-t px-4 py-3 text-xs">
            ...
            {/* TAB BAR */}
            <div className="sticky top-[230px] z-10 bg-background">
