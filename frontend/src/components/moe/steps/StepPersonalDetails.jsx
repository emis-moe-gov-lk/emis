...
export default function StepPersonalDetails({
  ...
  // Update helper - clears errors for that field and marks it as touched
    ...
    <div className="flex justify-center px-4 py-2">
      <div className="w-full max-w-4xl space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] gap-4">
          <FormGroup label="Title" required error={getFieldError("titleId")}>
            <Select
          ...
          <FormGroup label="Full Name" required error={getFieldError("fullName")}>
            <TextInput
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <FormGroup label="Gender" required error={getFieldError("genderId")}>
            <Select
          ...
          <FormGroup label="Ethnicity" required error={getFieldError("ethnicityId")}>
            <Select
          ...
          <FormGroup label="Religion" required error={getFieldError("religionId")}>
            <Select
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <FormGroup label="Date of Birth" required error={getFieldError("dateOfBirth")}>
            <TextInput
              type="date"
          ...
          <FormGroup label="Blood Group" required error={getFieldError("bloodGroupId")}>
            <Select
          ...
          <FormGroup label="Healthy?" required error={getFieldError("healthCondition")}>
            <Select
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <FormGroup label="Civil Status" required error={getFieldError("civilStatusId")}>
            <Select
          ...
          <div className="sm:col-span-2">
            <FormGroup
              ...
              error={getFieldError("healthConditionDescription")}
            >
              <Textarea
                rows={3}
        ...
        {/* Location Selection */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <FormGroup label="District" required error={getFieldError("districtId")}>
            <Select
          ...
          <FormGroup label="DS Office" required error={getFieldError("dsOfficeId")}>
            <Select
          ...
          <FormGroup label="GN Division" required error={getFieldError("gnDivisionId")}>
            <Select
