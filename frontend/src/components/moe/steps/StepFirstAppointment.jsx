...
export default function StepFirstAppointment({ formData, setFormData, onValid }) {
  ...
  const update = useCallback((key, value) => {
    ...
    setTouched((prev) => {
      ...
      if (key === "firstAppointmentService") {
        nextTouched.firstAppointmentRank = false;
        nextTouched.firstAppointmentPosition = false;
      }
      if (key === "firstAppointmentOfficeLevel") {
        nextTouched.firstAppointmentWorkplace = false;
      }
      return nextTouched;
    });
  ...
  return (
    <div className="space-y-6 px-4 py-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <FormGroup label="First Appointment Date" required error={getFieldError("firstAppointmentDate")}>
          <TextInput
            type="date"
        ...
        <FormGroup label="Appointment Letter No" required error={getFieldError("firstAppointmentLetter")}>
          <TextInput
        ...
        <FormGroup label="Service" required error={getFieldError("firstAppointmentService")}>
          <Select
        ...
        <FormGroup label="Service Rank" required error={getFieldError("firstAppointmentRank")}>
          <Select
        ...
        <FormGroup label="Position" required error={getFieldError("firstAppointmentPosition")}>
          <Select
        ...
        <FormGroup label="Office Level" required error={getFieldError("firstAppointmentOfficeLevel")}>
          <Select
            value={formData.firstAppointmentOfficeLevel || ""}
            disabled={loading}
            color={getFieldColor("firstAppointmentOfficeLevel")}
        ...
        <FormGroup label="Workplace" required error={getFieldError("firstAppointmentWorkplace")}>
          <Select
            value={formData.firstAppointmentWorkplace || ""}
            disabled={loading || !formData.firstAppointmentOfficeLevel}
            color={getFieldColor("firstAppointmentWorkplace")}
        ...
        <FormGroup label="Recruitment Category" required error={getFieldError("recruitmentCategory")}>
          <Select
            value={formData.recruitmentCategory || ""}
            disabled={loading}
            color={getFieldColor("recruitmentCategory")}
        ...
        <FormGroup label="Recruitment Subject" required error={getFieldError("recruitmentSubject")}>
          <Select
            value={formData.recruitmentSubject || ""}
            disabled={loading}
            color={getFieldColor("recruitmentSubject")}
