...
const AlertTeacherList = ({
  ...
  useEffect(() => {
    setLoading(true);
    api
      .get(`${endpoint}?per_page=20&page=${currentPage}`)
      .then((res) => {
              ...
              {filteredTeachers.map((teacher) => (
                ...
                >
                  <div className="flex items-center gap-4 min-w-[60px]">
                    <div
                      className={`p-2.5 bg-${color}-50 dark:bg-${color}-900/20 rounded-xl text-${color}-600 dark:text-${color}-400 group-hover:scale-110 transition-transform`}
                    >
                  ...
                  <div className="flex-1 min-w-0 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                    <div className="md:col-span-4">
                      <h3
                        className={`text-lg font-bold text-gray-900 dark:text-white truncate group-hover:text-${color}-600 transition-colors`}
                      >
                        {teacher.full_name}
                      </h3>
