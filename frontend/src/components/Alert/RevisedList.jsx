  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Revised</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Teacher profiles that have been revised after rejection</p>
        </div>
        <Badge color="purple" size="lg">Revised</Badge>
      </div>
        ...
        <div className="space-y-4">
          {filteredTeachers.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                    ...
                    <div className="md:col-span-2 flex items-center justify-end gap-2">
                      <Badge color="purple" className="px-3 py-1 whitespace-nowrap">Revised</Badge>
                      <Button
                        size="xs"
                        color="dark"
                        onClick={(e) => {
            ...
            <div className="text-center py-20 bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-500 max-w-sm mx-auto mt-2">No revised teacher profiles.</p>
            </div>
          )}
        </div>
      )}
