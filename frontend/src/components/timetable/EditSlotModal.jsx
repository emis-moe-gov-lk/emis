...
function EditSlotModal({ slot, onClose, onSave }) {
  ...
  const sorted = [...form.comments].sort((a, b) =>
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center">
      <div className="bg-white w-[420px] rounded-xl shadow-lg max-h-[90vh] flex flex-col">
        {/* Header */}
        <div
          className={`px-5 py-4 border-b shrink-0 ${isSpecial ? "bg-orange-50" : ""}`}
        >
        ...
        <div className="p-5 space-y-4 overflow-y-auto">
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (owner) {
                          setColorError(
                            `This color is already used by "${owner}"`,
                          );
                        } else {
                          setColorError("");
          ...
          {!isSpecial && (
            <div className="rounded-lg border border-violet-200 bg-violet-50/40 p-3.5 space-y-2.5">
              <p className="text-xs font-semibold text-violet-700">Reminders</p>
          ...
          <button
            ...
            onClick={async () => {
              ...
              if (!isSpecial) {
                ...
                if (colorOwner) {
                  setColorError(
                    `This color is already used by "${colorOwner}"`,
                  );
                  return;
                }
              }
              ...
              try {
                ...
                await onSave({
                  ...
                  purpose: isSpecial ? form.purpose : undefined,
                });
              } catch (err) {
