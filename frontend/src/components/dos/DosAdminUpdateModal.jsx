...
export default function DosAdminUpdateModal({
	isOpen,
	section,
	adminId,
	onClose,
	...
	useEffect(() => {
		...
		api
			...
			.catch((err) => {
				console.error("[DosAdminUpdateModal] Load error:", err);
	...
	const handleSave = async () => {
		...
		try {
			...
			const res = await api.patch(`/dos-admins/${adminId}`, payload);

			toast.success("Updated successfully");
			onClose();
			onSaved?.(res.data);
		} catch (error) {
			console.error("[DosAdminUpdateModal] Save error:", error);
