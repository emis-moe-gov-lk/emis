...
const WeeklySchedule = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800/50 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-slate-900/30 border border-slate-50 dark:border-gray-700 p-8 flex flex-col">
      {/* HEADER */}
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          <button
            onClick={onPrevWeek}
            className="p-2.5 hover:bg-slate-50 dark:hover:bg-gray-700 border border-slate-100 dark:border-gray-600 rounded-xl text-slate-400 dark:text-gray-400 transition-all"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      {/* WEEK DAYS */}
      <div className="flex justify-between items-center mb-10 bg-slate-50/50 dark:bg-gray-700/30 p-2 rounded-2xl border border-slate-50 dark:border-gray-700">
