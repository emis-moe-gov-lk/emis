...
const StatCard = ({ title, value, badge, color, icon: Icon }) => {
  ...
  return (
    <div
      className={`group relative bg-white dark:bg-gray-800/40 border border-slate-200 dark:border-gray-700 rounded-2xl p-4 transition-all duration-300 ${style.border} hover:shadow-md`}
    >
      <div
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <div className="w-12 h-12 bg-slate-50 dark:bg-gray-700 rounded-xl flex items-center justify-center">
