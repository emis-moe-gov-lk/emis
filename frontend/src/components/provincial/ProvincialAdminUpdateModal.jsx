...
export default function ProvincialAdminUpdateModal({
	isOpen,
	section,
	adminId,
	onClose,
	...
	useEffect(() => {
		...
		api
			...
			.catch((err) => {
				console.error("[ProvincialAdminUpdateModal] Load error:", err);
	...
	const handleSave = async () => {
		...
		try {
			...
			const res = await api.put(`/provincial-admins/${adminId}`, payload);

			toast.success("Updated successfully");
			onClose();
			onSaved?.(res.data);
		} catch (error) {
			console.error("[ProvincialAdminUpdateModal] Save error:", error);
