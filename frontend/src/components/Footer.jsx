        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">EduNational</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Transforming national education through innovative digital solutions. 
              Empowering students, teachers, and institutions nationwide.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Resource Planning</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Mobile Learning</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-start space-x-3">
                ...
                <span>Ministry of Education<br />Government Complex<br />National Capital</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>info@edunational.gov</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {currentYear} National Education Management System. All rights reserved.
            </p>
