...
export const TeacherFormContext = createContext();

const STORAGE_KEY = "teacher_form_draft_v2";
...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "SET_FIRST_APPT_VALID":
      return { ...state, isFirstApptValid: action.payload };
...
export function TeacherFormProvider({ children }) {
  ...
  return (
    <TeacherFormContext.Provider value={{ state, dispatch }}>
      {children}
